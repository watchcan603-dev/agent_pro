---
name: boot-analysis
description: ARM Linux device boot flow analysis covering BootROM, U-Boot, kernel init, and userspace startup. Diagnose boot failures, driver load issues, and systemd errors.
---
