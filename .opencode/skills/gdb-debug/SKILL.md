---
name: gdb-debug
description: GDB remote debugging for ARM Linux programs via gdbserver. Covers ARM register reference, backtrace analysis, kgdb kernel debugging, and GDB/MI mode commands.
---
