---
name: firmware-flash
description: ARM Cortex-A Linux device firmware flashing via MTD partitions. Covers CPU-specific partition tables (RK3566, i.MX6ULL), flash_erase + cat workflow, safety checks, and verification.
---
